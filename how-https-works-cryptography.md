...
The cryptographic stack underlying HTTPS like asymmetric authentication, key exchange, symmetric encryption, and hashing — is not limited to websites. It underpins:
...
*Topics covers: TLS/SSL, RSA, ECC, AES, Diffie-Hellman, SHA-256, Digital Certificates, MITM attacks.*
